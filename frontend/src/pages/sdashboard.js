...
export const SDashboard = () => {
  const [nav,setNav]=useState({per:false,time:true});
  const handleNav = (num) => {
    if (num === 1) {
      setNav({ ...nav, time: true, per: false });
    } else if (num === 2) {
      setNav({ ...nav, per: true, time: false });
    }
  };
...
<nav class="sidebar locked">
      ...
      <div class="menu_container">
        ...
        <div class="menu_items">
          ...
          <ul class="menu_item" >
            <li class="item" onClick={()=>handleNav(1)}>
              <a href="#" class="link flex">
                <i class="bx bxs-magic-wand"></i>
                <span>Timetable</span>
              </a>
            </li>
            <li class="item" onClick={()=>handleNav(2)}>
              <a href="#" class="link flex">
